...
object drugTest {
  ...
  def main(args: Array[String]) {
    ...
    val path = args(1)
    val N = args(2).toInt
    val filePath = path + "Generated_" + N + "/DRUG" + "14Q3-18Q2/"
    ...
    var factsDF = drugDF.select(drugDF.col("primaryid").as("argument_X"))
    ...
    */
    ...
    println("DRUG Total execution time = " + durationSeconds + " seconds")
