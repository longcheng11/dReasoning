...
object rpsrTest {
  ...
  def main(args: Array[String]) {
    ...
    val path = args(1)
    val N = args(2).toInt
    val filePath = path + "Generated_" + N + "/RPSR" + "14Q3-18Q2/"
    ...
    var factsDF = rpsrDF.select(rpsrDF.col("primaryid").as("argument_X"))
    ...
    */
    ...
    println("RPSR Total execution time = " + durationSeconds + " seconds")
