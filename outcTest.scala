...
object outcTest {
  ...
  def main(args: Array[String]) {
    ...
    val path = args(1)
    val N = args(2).toInt
    val filePath = path + "Generated_" + N + "/OUTC" + "14Q3-18Q2/"
    ...
    var factsDF = outcDF.select(outcDF.col("primaryid").as("argument_X"))
    ...
    */
    ...
    println("OUTC Total execution time = " + durationSeconds + " seconds")
